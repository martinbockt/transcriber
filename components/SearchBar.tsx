  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        <div className="text-xs font-medium text-muted-foreground px-1">Filter by type:</div>
      ...
      {/* Date Range Filters */}
      <div className="space-y-2">
        <div className="text-xs font-medium text-muted-foreground px-1">Filter by date:</div>
        <div className="flex flex-wrap gap-2">
