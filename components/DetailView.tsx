          ...
          <div>
            <div className="flex items-start justify-between mb-2">
              {isEditingTitle ? (
                ...
                <h1
                  className="text-3xl font-bold cursor-pointer hover:underline decoration-dashed decoration-primary/50 underline-offset-4 transition-all"
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          &rdquo; and all associated data. This action cannot be
                          undone.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
            ...
            <Card>
              ...
              <CardContent>
                {isEditingSummary ? (
                  ...
                  <p
                    className="text-sm leading-relaxed cursor-pointer hover:bg-muted/50 p-1 -m-1 rounded transition-colors"
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between w-full">
                <Button
                  variant="ghost"
                  className="flex-1 justify-between p-2 -ml-2 h-auto hover:bg-muted/50 hover:text-foreground rounded-md transition-colors"
